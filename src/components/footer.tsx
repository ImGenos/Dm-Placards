          ...
          <motion.div variants={itemVariants} className="flex flex-col space-y-6">
            ...
            <ul className="space-y-4">
              <li className="text-text-gray-200 flex items-start">
                <svg className="w-5 h-5 mt-1 mr-3 flex-shrink-0 text-primary-100" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <a href="mailto:dm.placards@wanadoo.fr" className="text-text-gray-200 hover:text-primary-100 transition-all flex items-center group">
                  <svg className="w-5 h-5 mr-3 text-primary-100 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="mt-16 bg-primary-200 py-8 px-6">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-white font-jost text-lg md:text-xl">Vous avez un projet d'aménagement sur mesure ?</p>
            <a href="/contact" className="bg-primary-100 hover:bg-opacity-90 text-white px-8 py-3 rounded-full font-jost transition-all transform hover:scale-105">
              Contactez-nous
            </a>
          </div>
        </div>
